	...
	f.registerView(() => {
		...
		return $.div.maxWMd.mxAuto.flex.flexCol.itemsCenter.p_6.bgWhite.rounded.shadowXl.my_3.h([
			...
			f.modelProps.accountId ?
				...
				]) : f.modelProps.loading ? $.div.textGray_700.textCenter.h(['Logging In...']) :
...
export default function loginComponent(global: (proposal: Partial<RealWorldProps>) => void): IMountable<LoginProps> {
	return
}
